...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{route('index')}}">CRG</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    @auth
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page">Hi {{Auth::user()->name}}</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('packages') ? 'active' : '' }}" aria-current="page"
                                href="{{route('packages.index')}}">แพ็กเกจ</a>
                        </li>
                        <li class="nav-item">
                            <form aria-current="page" action="{{route('logout')}}" method="POST">
                                @csrf
